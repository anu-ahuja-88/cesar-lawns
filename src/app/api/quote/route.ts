...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    await resend.emails.send({
      ...
      to: ['info@cesarslawnsservices.co.nz'],
      replyTo: email,
      subject: `New quote request — ${service} (${name})`,
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background: #1C5C37; padding: 32px; border-radius: 12px 12px 0 0;">
            <h1 style="color: #fff; font-size: 24px; margin: 0 0 4px;">New Quote Request</h1>
            <p style="color: rgba(255,255,255,0.6); font-size: 14px; margin: 0;">From the Cesar's Lawns Services website</p>
          </div>
          <div style="background: #f8f9fa; padding: 32px; border-radius: 0 0 12px 12px; border: 1px solid #e9ecef;">
            <table style="width: 100%; border-collapse: collapse;">
              ...
              <tr>
                ...
                <td style="padding: 12px 0; border-bottom: 1px solid #e9ecef; color: #212529; font-size: 15px; font-weight: 600;">
                  <a href="tel:${phone}" style="color: #1C5C37; text-decoration: none;">${phone}</a>
                </td>
              </tr>
              <tr>
                <td style="padding: 12px 0; border-bottom: 1px solid #e9ecef; color: #6c757d; font-size: 13px; vertical-align: top;">Email</td>
                <td style="padding: 12px 0; border-bottom: 1px solid #e9ecef; color: #212529; font-size: 15px; font-weight: 600;">
                  <a href="mailto:${email}" style="color: #1C5C37; text-decoration: none;">${email}</a>
                </td>
              </tr>
              <tr>
            ...
            <div style="margin-top: 24px; padding: 16px; background: #e8f5ee; border-radius: 8px; border-left: 4px solid #1C5C37;">
              <p style="margin: 0; font-size: 14px; color: #1C5C37;">
